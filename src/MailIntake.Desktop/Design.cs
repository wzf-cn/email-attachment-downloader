...
internal sealed class ActionButton : AntdUI.Button
{
    ...
    private void UpdateHelp()
    {
        ...
        if(UiLanguage.English)description=label switch
        {
            ...
            "清空检索"=>"Clear the search and show all archive records.",
            ...
            "PayPal 赞助"=>"Open the developer's PayPal.Me page in your browser. Payment is entirely optional.",
...
internal static class ButtonHelp
{
    ...
    {
        "采用建议关键词"=>"用上方建议替换关键词输入框中的内容；保存规则后生效。",
        ...
        "赞助支持"=>"查看自愿打赏方式，支持软件的开发和维护。",
        "打开打赏页面"=>"在浏览器打开作者提供的打赏页面，由你决定是否支付。",
        "PayPal 赞助"=>"在浏览器打开作者的 PayPal.Me 页面，自行选择是否打赏。",
        "查看微信支付原图" or "查看支付宝原图"=>"打开原始收款码图片，方便放大查看或扫码。",
        "关闭"=>"关闭当前窗口，返回软件。",
